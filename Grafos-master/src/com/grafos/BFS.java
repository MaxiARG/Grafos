...
public class BFS {
	...
	public void ejecutar() throws IOException {
		...
		this.escribirSolucionEnArchivo("BFS" + "_" + this.cantNodos + "_" + ".out");
	}

	public void escribirSolucionEnConsola() {
		//Si quiero imprimir el caminito de vertices tomo el nodo 1 y nodo 2 de la primer arista y luego solo el nodo 2.
